...
public class SeckillServiceImpl implements SeckillService {
    ...
    public SeckillExecution executeSeckill(long seckillId, long userPhone, String md5)
        ...
        if (md5 == null || !md5.equals(getMd5(seckillId))) {
            throw new SeckillException("com.seckill data rewrite");
        }
...
//            获取行级锁
            ...
            if (updateCount <= 0) {
                throw new SeckillCloseException("com.seckill is closed");
            } else {
                int insertCount = successKilledDao.insertSuccessKilled(seckillId, userPhone);
                if (insertCount <= 0) {
                    throw new RepeatKillException("com.seckill repeated");
                } else {
            ...
            throw new SeckillException("com.seckill inner error:" + e.getMessage());
        }
    }
