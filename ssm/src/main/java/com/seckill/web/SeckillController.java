...
//        list.jsp + model = ModelAndView
    ...
    public String detail(@PathVariable("seckillId") Long seckillId, Model model) {
        if (seckillId == null) {
            return "redirect:/com.seckill/list";
        }

        Seckill seckill = seckillService.getById(seckillId);
        if (seckill == null) {
            return "forward:/com.seckill/list";
        }

        model.addAttribute("com/seckill", seckill);
    ...
    public SeckillResult<SeckillExecution> execute(@PathVariable("seckillId") Long seckillId,
        ...
        if (userPhone == null) {
            return new SeckillResult<SeckillExecution>(false, "no user");
        }
        ...
        try {
            ...
            SeckillExecution execution = new SeckillExecution(seckillId, SeckillStateEnum.INNRE_ERROR);
